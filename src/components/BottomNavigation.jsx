...
const BottomNavigation = () => {
    return (
        <div style={{
            ...
            {/* Nav Item 1 */}
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px', color: 'var(--color-sage-green)' }}>
                <Home size={24} />
                <span style={{ fontSize: '10px', fontWeight: '500' }}>Home</span>
            </div>

            {/* Nav Item 2 */}
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px', color: '#999' }}>
                <Users size={24} />
